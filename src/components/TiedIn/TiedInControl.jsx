    ...
    <div style={{ minHeight: '100dvh', width: '100%', background: 'var(--bg, #0a0a0a)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
      ...
      <main className="overlay-root no-scrollbar" style={{ width: '100%', maxWidth: '640px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', overflowY: 'auto', overflowX: 'hidden', padding: 'var(--space-16, 16px)', gap: 'var(--space-16, 16px)', flex: 1 }}>
       ...
       <div className="context-pill stack" style={{ padding: 'var(--space-16, 16px)', background: 'var(--panel-bg)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-16, 16px)' }}>
             {/* Contacted Column */}
             <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--space-12, 12px)' }}>
             ...
             <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--space-12, 12px)' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--space-4, 4px)' }}>
                   ...
                   <span style={{ fontSize: '10px', background: 'var(--white-12)', color: 'var(--white-92)', padding: '2px 6px', borderRadius: '4px' }}>+1% CVR</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-12, 12px)' }}>
